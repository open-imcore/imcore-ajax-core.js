...
var IMContactClient = /** @class */ (function (_super) {
    __extends(IMContactClient, _super);
     ...
     */
    IMContactClient.prototype.fetchOne = function (contactID) {
        return __awaiter(this, void 0, void 0, function () {
            var contactRepresentation;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.get(endpoints_1.contact(contactID))];
                    case 1:
                        contactRepresentation = (_a.sent()).data;
                        return [2 /*return*/, contactRepresentation];
                }
            });
        });
    };
     ...
     * Gets all contacts
     */
    IMContactClient.prototype.fetchAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            var results;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.get(endpoints_1.contacts)];
                    case 1:
