...
var IMAttachmentClient = /** @class */ (function (_super) {
    __extends(IMAttachmentClient, _super);
     ...
     */
    IMAttachmentClient.prototype.create = function (attachment, mime) {
        return __awaiter(this, void 0, void 0, function () {
            var attachmentRepresentation;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.axios.post("" + this.baseURL + endpoints_1.attachments, attachment, {
                            headers: {
                                'content-type': mime || "application/octet-stream"
                            }
                        })];
                    case 1:
                        attachmentRepresentation = (_a.sent()).data;
                        return [2 /*return*/, attachmentRepresentation];
                }
            });
        });
    };
