...
var attachment_client_1 = require("./attachment-client");
var chat_client_1 = require("./chat-client");
var contact_client_1 = require("./contact-client");
...
var IMHTTPClient = /** @class */ (function (_super) {
     ...
     */
    IMHTTPClient.prototype.resourceURL = function (identifier) {
        return "" + this.baseURL + endpoints_1.resource(identifier);
    };
    /**
     * Resolves the URL of an attachment with the given ID
     * @param id ID of the URL to resolve
     */
    IMHTTPClient.prototype.attachmentURL = function (id) {
        return "" + this.baseURL + endpoints_1.attachment(id);
    };
    /**
     * Resolves the URL of the contact photo with the given contact ID
     * @param contactID contactID of the URL to resolve
     */
    IMHTTPClient.prototype.contactPhotoURL = function (contactID) {
        return "" + this.baseURL + endpoints_1.contact(contactID) + "/photo";
    };
    IMHTTPClient.prototype.getResourceMode = function () {
        return __awaiter(this, void 0, void 0, function () {
            var mode;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.get(endpoints_1.resource("mode"))];
                    case 1:
                        mode = (_a.sent()).data.mode;
